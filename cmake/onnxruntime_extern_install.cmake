...
install(FILES ${PROJECT_SOURCE_DIR}/../onnxruntime/core/providers/cpu/nn/pool_attributes.h  DESTINATION ${CMAKE_INSTALL_INCLUDEDIR}/onnxruntime/core/providers/cpu/nn)
install(FILES ${PROJECT_SOURCE_DIR}/../onnxruntime/core/providers/cpu/nn/conv_attributes.h  DESTINATION ${CMAKE_INSTALL_INCLUDEDIR}/onnxruntime/core/providers/cpu/nn)
install(FILES ${PROJECT_SOURCE_DIR}/../onnxruntime/core/providers/cpu/nn/conv_transpose_attributes.h  DESTINATION ${CMAKE_INSTALL_INCLUDEDIR}/onnxruntime/core/providers/cpu/nn)
install(FILES ${PROJECT_SOURCE_DIR}/../onnxruntime/core/providers/cpu/quantization/dynamicquantizelinear.h  DESTINATION ${CMAKE_INSTALL_INCLUDEDIR}/onnxruntime/core/providers/cpu/quantization)
install(FILES ${PROJECT_SOURCE_DIR}/../onnxruntime/core/providers/cpu/tensor/reshape_helper.h  DESTINATION ${CMAKE_INSTALL_INCLUDEDIR}/onnxruntime/core/providers/cpu/tensor)
install(FILES ${PROJECT_SOURCE_DIR}/../onnxruntime/core/providers/cpu/math/matmul_helper.h  DESTINATION ${CMAKE_INSTALL_INCLUDEDIR}/onnxruntime/core/providers/cpu/math)
install(FILES ${PROJECT_SOURCE_DIR}/../onnxruntime/contrib_ops/cpu/bert/attention_base.h  DESTINATION ${CMAKE_INSTALL_INCLUDEDIR}/onnxruntime/contrib_ops/cpu/bert)
install(FILES ${PROJECT_SOURCE_DIR}/../onnxruntime/contrib_ops/cpu/bert/attention_common.h  DESTINATION ${CMAKE_INSTALL_INCLUDEDIR}/onnxruntime/contrib_ops/cpu/bert)
install(FILES ${PROJECT_SOURCE_DIR}/../onnxruntime/contrib_ops/cpu/bert/attention_helper.h  DESTINATION ${CMAKE_INSTALL_INCLUDEDIR}/onnxruntime/contrib_ops/cpu/bert)
install(FILES ${PROJECT_SOURCE_DIR}/../onnxruntime/contrib_ops/cpu/bert/attention_utils.h  DESTINATION ${CMAKE_INSTALL_INCLUDEDIR}/onnxruntime/contrib_ops/cpu/bert)
install(FILES ${PROJECT_SOURCE_DIR}/../onnxruntime/contrib_ops/cpu/utils/console_dumper.h  DESTINATION ${CMAKE_INSTALL_INCLUDEDIR}/onnxruntime/contrib_ops/cpu/utils)
install(FILES ${PROJECT_SOURCE_DIR}/../onnxruntime/contrib_ops/cpu/utils/dump_tensor.h  DESTINATION ${CMAKE_INSTALL_INCLUDEDIR}/onnxruntime/contrib_ops/cpu/utils)
install(FILES ${PROJECT_SOURCE_DIR}/../onnxruntime/contrib_ops/cpu/utils/debug_macros.h  DESTINATION ${CMAKE_INSTALL_INCLUDEDIR}/onnxruntime/contrib_ops/cpu/utils)
...
install(FILES ${PROJECT_SOURCE_DIR}/../onnxruntime/core/common/cpuid_arch_definition.h  DESTINATION ${CMAKE_INSTALL_INCLUDEDIR}/onnxruntime/core/common)
install(FILES ${PROJECT_SOURCE_DIR}/../onnxruntime/core/common/cpuid_info.h  DESTINATION ${CMAKE_INSTALL_INCLUDEDIR}/onnxruntime/core/common)
...
install(FILES ${PROJECT_SOURCE_DIR}/../onnxruntime/core/graph/graph_proto_serializer.h  DESTINATION ${CMAKE_INSTALL_INCLUDEDIR}/onnxruntime/core/graph)
...
install(FILES ${PROJECT_SOURCE_DIR}/../onnxruntime/core/framework/node_unit.h  DESTINATION ${CMAKE_INSTALL_INCLUDEDIR}/onnxruntime/core/framework)
...
install(FILES ${PROJECT_SOURCE_DIR}/../onnxruntime/core/mlas/inc/mlas.h DESTINATION ${CMAKE_INSTALL_INCLUDEDIR}/onnxruntime/core/mlas/inc)
install(FILES ${PROJECT_SOURCE_DIR}/../onnxruntime/core/mlas/inc/mlas_qnbit.h DESTINATION ${CMAKE_INSTALL_INCLUDEDIR}/onnxruntime/core/mlas/inc)
install(FILES ${PROJECT_SOURCE_DIR}/../onnxruntime/core/mlas/inc/mlas_gemm_postprocessor.h DESTINATION ${CMAKE_INSTALL_INCLUDEDIR}/onnxruntime/core/mlas/inc)
install(FILES ${PROJECT_SOURCE_DIR}/../onnxruntime/core/mlas/lib/qnbitgemm.h DESTINATION ${CMAKE_INSTALL_INCLUDEDIR}/onnxruntime/core/mlas/lib)
install(FILES ${PROJECT_SOURCE_DIR}/../onnxruntime/core/mlas/lib/sqnbitgemm_q8_block.h DESTINATION ${CMAKE_INSTALL_INCLUDEDIR}/onnxruntime/core/mlas/lib)
install(FILES ${PROJECT_SOURCE_DIR}/../onnxruntime/core/mlas/lib/mlasi.h DESTINATION ${CMAKE_INSTALL_INCLUDEDIR}/onnxruntime/core/mlas/lib)
